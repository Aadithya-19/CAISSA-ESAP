"""
Testbench for rtl/sensor/stp_sr.sv.

test_stp_sr.py builds this at WIDTH 8 and 12. Nothing here reads WIDTH from a
constant - it comes off the DUT port, so the same tests cover both.
"""
...
async def start(dut):
    ...
    # width comes off the port, never a constant. test_stp_sr.py runs 8 and 12.
